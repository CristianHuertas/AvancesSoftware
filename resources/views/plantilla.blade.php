...
<body>
    ...
    {{-- aca uso el cabecero bonito de laraver de autenticacion --}}
    <x-app-layout>
        <x-slot name="header">
        </x-slot>
...
{{-- 
    <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
            <button type="button" class="btn btn-outline-primary">Compras</button>

        </li>
        <li class="nav-item">
            <button type="button" class="btn btn-outline-primary">Otro</button>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="{{ route('productos.lista') }}">Inicio</a>
            </li>
            <li class="nav-item">
